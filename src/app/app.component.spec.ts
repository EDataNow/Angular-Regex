...
    expect(app.matchOnAnyPosition(barcode, '1')).toEqual('12345-A500-H1');
    //expect(app.matchOnFirstCharacter(barcode1, 'P')).not.toEqual('P12345-A500-H1');
  });
...
    expect(app.matchOnAnyPositionReturnStringProceedingMatchIncludingMatch(barcode1, '1')).toEqual('12345-A500-H1');
  });
...
    expect(app.matchOnAnyPositionReturnStringProceedingMatchNotIncludingMatch(barcode1, 'H')).toEqual('1');
  });
...
    expect(app.matchOnAnyPositionReturnStringProceedingMatchIncludingMatchOfSpecificLength(barcode1, '1', 3)).toEqual('1234');
  });
...
    expect(app.matchGivenIndexAndSpecificLengthIncludeMatch(barcode1, 8, 3)).toEqual('A500');
    ...
    expect(app.matchGivenIndexAndSpecificLengthIncludeMatch(barcode1, 1, 5)).toEqual('P12345');
